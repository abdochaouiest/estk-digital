...
class ShowStudentDetails extends StatefulWidget {
  ...
  const ShowStudentDetails({super.key, required this.massar, required this.nom, this.gender, required this.prenom, required this.email, required this.studentid,required this.phonenuber,required this.dateofbirth});

  @override
  State<ShowStudentDetails> createState() => _ShowEnseignantDetailsState();
}

class _ShowEnseignantDetailsState extends State<ShowStudentDetails> {
