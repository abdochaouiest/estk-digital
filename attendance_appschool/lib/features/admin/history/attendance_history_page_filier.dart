...
import 'package:attendance_appschool/features/admin/history/attendance_details_page_Filier.dart';
...
import 'package:flutter_svg/flutter_svg.dart';
          ...
          class AttendanceHistoryFilierPage extends StatefulWidget {
            final int filierid;
            const AttendanceHistoryFilierPage({super.key, required this.filierid});

            @override
            State<AttendanceHistoryFilierPage> createState() => _AttendanceHistoryPageState();
          }

          class _AttendanceHistoryPageState extends State<AttendanceHistoryFilierPage> {
            ...
            void initState() {
              ...
              Future<List<Map<String, dynamic>>> _loadAttendanceHistory() async {
                return dbHelper.getAttendanceHistoryWithDetailsbyidfilier(widget.filierid);
              }
                                          ...
                                          child:Container(
                                            ...
                                            children: [
                                              SizedBox(
                                                ...
                                                child: Image.asset(
                                                  'assets/File searching-rafiki.png', // Replace 'your_image.png' with the path to your image asset
                                                                      ...
                                                                      children:<Widget> [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              DateFormat.Hm().format(DateTime.parse(historiquePresence[index][DBHelper.ATTENDANCE_HISTORY_DATE])), // Format the time
                                                                              textAlign: TextAlign.center,
                                                                              style: TextStyle(
                                                                                color: Colors.black,
                                                                                fontFamily: 'Sarala',
            ...
            void naviguerVersDetails(int idHistoriquePresence) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AttendanceDetailsFilierPage(attendanceHistoryId: idHistoriquePresence),
                ),
              );
            }
          }
